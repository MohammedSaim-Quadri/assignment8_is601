...
def client():
    ...
    This fixture initialized a Testclient instance that can be used to simulate
    requests to the FastAPI application without running a live server. The client
    is yielded to the test functions adn properly closed after the tests complete.
