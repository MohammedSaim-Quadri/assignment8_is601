...
def test_hello_world(page, fastapi_server):
    ...
    This test verifies htat when a user navigates to the homepage of the application,
    the main header ('<h1>') correctly displays the test "Hello World". This ensures
    ...
    # use and assertion to chech that the text within the first <h1> tag is exactly "Hello World".
